...
public interface UserRepository extends Neo4jRepository<User, Long> {
    @Query("MERGE (u:User {username: $username, mail:$mail, bucketId:$bucketId}) RETURN u")
    User saveToGraph(@Param("username")String username, @Param("mail") String mail, @Param("bucketId") String bucketId);
